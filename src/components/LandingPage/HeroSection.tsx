...
const HeroSection: React.FC = () => {
  return (
    <section className="relative w-full bg-gray-900 text-white flex flex-col items-center justify-between px-6 md:px-20 py-16 gap-8">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start justify-between w-full gap-4 mt-12 md:mt-0">
