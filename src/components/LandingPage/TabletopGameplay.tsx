      ...
      <section className="hidden md:flex w-full bg-cover bg-center flex-col items-center justify-center gap-0 md:gap-8 relative overflow-hidden max-w-[1440px] ">
        <div className="flex items-center justify-center bg-[url(/lp/tableTopgameplaybg.png)] bg-cover bg-top w-full min-h-screen relative overflow-hidden px-6 md:px-0">
          <div className="w-full max-w-[900px] mx-auto flex flex-col items-start md:items-center justify-center text-left md:text-center px-4">
            ...
            <p className="text-white text-[18px] md:text-[24px] leading-[24px] md:leading-[40px] font-medium tracking-[-0.72px] md:tracking-[-0.96px] text-left md:text-center">
              Our web apps speed up table math, automate custom dice rolls or
              card
              <br />
      ...
      <section className="flex w-full bg-top bg-cover bg-[url(/lp/tableTopgameplaybg-mob.png)] flex-col relative overflow-hidden md:hidden">
        <div className="flex w-full  h-full mb-40 relative">
          <div className="w-full flex flex-col px-6 mt-[102px]">
            ...
            <div className="w-full h-[80px] bg-cover bg-center bg-[url('/lp/tabletopGameplay-mob.png')] my-7" />

            <p className="text-[18px] text-white leading-6 tracking-[-0.72px] font-normal">
              Our web apps speed up table math, automate custom dice rolls or
              card draws, and enable dynamic character sheets with stats and
              status effects that update on the fly.
            </p>
          </div>
        </div>
        <div className="w-full h-full bottom-0 bg-[#FC5212] md:hidden">
          <div className="p-3 text-[16px] text-white font-normal leading-6 flex flex-col text-center items-center justify-center h-full">
            <p>
              Introducing Our New Games <br />
              Beta Begins Q4 2025
            </p>
          </div>
        </div>
