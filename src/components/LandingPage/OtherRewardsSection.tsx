...
const OtherRewardsSection: React.FC = () => {
  return (
    <>
      {/*VERSÃO DESKTOP*/}
      <section className="hidden md:block w-full text-white px-4 py-12 md:py-0">
          ...
          <div className="flex flex-col max-w-[576px] flex-1 space-y-4 md:space-y-6">
            ...
            <div>
              <p className="text-white font-normal font-['Inter'] text-[16px] leading-[24px] md:text-[18px] md:leading-[28px]">
                ...
                Gaming grimoires. Digital copies of TTRPG rulebooks—yours to
                keep, free of charge. Don’t believe us? Consider the following a
                down payment for your heroic deeds…
              </p>
            </div>
          </div>
      ...
      <section className="w-full text-white px-6 md:hidden">
        <div className="flex flex-col">
          <div className="flex flex-col">
            ...
            <div className="pt-4">
              <p className="text-white font-normal text-[16px] leading-6">
                The greatest kind of rewards. Books of sorcery and adventure.
                Gaming grimoires. Digital copies of TTRPG rulebooks—yours to
                keep, free of charge. Don’t believe us? Consider the following a
                down payment for your heroic deeds…
          ...
          <div
            className="p-[1px] rounded-xl w-full mt-8"
            style={{
              background:
                "linear-gradient(300deg, #002C45 0%, #F45111 35%, #199FEC 70%, #002C45 100%)",
            }}
          >
            <div
              className="relative w-full h-[229px] rounded-[12px] border bg-black overflow-hidden"
              style={{
                borderColor:
                  "var(--Transparent-secondary-T2-30, rgba(25, 159, 236, 0.30))",
              }}
            >
              <div className="flex h-[228px] w-full rounded-xl bg-[url('/lp/get-core-img.png')] bg-center bg-cover">
                <div className="flex flex-col justify-betweenw-full h-full">
                  <div className="flex flex-col items-start justify-between px-6 py-[15px] h-full">
                    <h3 className="text-white font-normal text-[18px] leading-6 tracking-[-0.72px]">
                      Anno Amagium:
                      <br />
                      The RPG - Core Rules
                    </h3>
