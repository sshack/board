    ...
    <>
      ...
      <section className="hidden w-full bg-cover bg-center bg-[url('/lp/homeSectionBg.png')] bg-gray-900 text-white lg:flex flex-col gap-8 relative overflow-hidden max-w-[1440px]">
        <div className=" flex flex-row items-center justify-between w-full gap-8">
          <div className="w-full space-y-8 text-left z-20 px-6 lg:px-20 mt-[236px]">
            <h1 className="text-[60px] sm:text-[70px] md:text-[90px] lg:text-[110px] xl:text-[124px] leading-[56px] sm:leading-[64px] md:leading-[80px] lg:leading-[96px] xl:leading-[108px] font-bold tracking-[-2px] sm:tracking-[-3px] md:tracking-[-4px] lg:tracking-[-5px] xl:tracking-[-7.44px]">
              Game. On.
              <br className="hidden lg:block" /> Echelon.
            </h1>
            <p className="text-[18px] lg:text-[20px] leading-[28px] pb-[54px] font-medium tracking-[-0.8px] w-full lg:max-w-xl">
              A platform for online/hybrid (digitally augmented) tabletop gaming
              and digitally publishing original RPG systems.
            </p>
          </div>
        </div>
        <div className="hidden lg:block absolute -bottom-4 right-0 w-1/2">
          <Image
