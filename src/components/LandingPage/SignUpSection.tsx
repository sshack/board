...
const SignUpSection: React.FC = () => {
  ...
  return (
    <section
      ...
      className="w-full bg-cover bg-center flex flex-col items-center justify-center gap-0 md:gap-8 relative overflow-hidden max-w-[1440px] my-[60px] px-6 md:px-0"
    >
      ...
      >
        <div className="relative bg-[url('/lp/SignUpSection/join-our-party-bg-mob.png')] h-[760px] bg-cover bg-center flex md:bg-[url('/lp/SignUpSection/fundo2last.png')] p-6 md:pr-0 md:pl-20 md:py-20 items-center rounded-[20px] overflow-hidden md:w-full">
          {/* Content wrapper for desktop grid layout */}
          <div className="w-full h-full flex flex-col md:flex-row md:gap-8 items-center">
            {/* Form */}
            <div className="flex pt-16 md:pt-0 flex-col justify-start md:justify-center items-center md:items-start h-full space-y-10 md:space-y-20 w-full md:flex-shrink-0 md:max-w-[500px]">
            ...
            {/* Image */}
            <div className="hidden md:flex flex-1 h-full min-w-0 justify-end items-center">
              <div
